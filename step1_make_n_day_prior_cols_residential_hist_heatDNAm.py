...
hrs_filename = 'HRSprep2016full.dta' # prepared HRS file name
...
heat_data_dir = r'C:\Users\BioDem\Documents\BioDem\Users\Nam\Linkage\data\daily_heat_long'
heat_data_all = HeatIndexDataDir(heat_data_dir)

residential_hist = ResidentialHistoryHRS(residential_hist_filename)
hrs_epi_data = HRSEpigenetics(os.path.join(hrs_data_dir, hrs_filename), datecol="iwdate", move=True, residential_hist=residential_hist)
